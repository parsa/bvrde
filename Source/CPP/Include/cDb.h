#if !defined(AFX_CDB_H__20011208_E6E3_45BF_60C8_0080AD509054__INCLUDED_)
#define AFX_CDB_H__20011208_E6E3_45BF_60C8_0080AD509054__INCLUDED_

/////////////////////////////////////////////////////////////////////////////
// cDb.h - Generic database interface
//
...
public:
   ...
   virtual CDbDatabase*  CreateDatabase() = 0;
   virtual CDbRecordset* CreateRecordset(CDbDatabase* pDb) = 0;
   virtual CDbCommand*   CreateCommand(CDbDatabase* pDb) = 0;
};
...
public:
   ...
   virtual CDbError* GetError(short iIndex) = 0;
};
...
public:
   ...
   virtual BOOL Execute(CDbRecordset* pRecordset = NULL) = 0;
   virtual void Close() = 0;
   virtual BOOL IsOpen() const = 0;
   virtual DWORD GetRowCount() const = 0;
...
#endif // !defined(AFX_CDB_H__20011208_E6E3_45BF_60C8_0080AD509054__INCLUDED_)
