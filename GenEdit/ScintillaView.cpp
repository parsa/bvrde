...
bool CScintillaView::_IsValidInsertPos(long lPos) const
{
   ...
   } Types[] =
   {
      ...
      { SCE_H_COMMENT,         _T("xml") },
      { SCE_H_SINGLESTRING,    _T("xml") },
      { SCE_H_DOUBLESTRING,    _T("xml") },
      { SCE_HJ_COMMENT,        _T("java") },
      { SCE_HJ_STRINGEOL,      _T("java") },
      { SCE_HJ_COMMENTLINE,    _T("java") },
      { SCE_HJ_SINGLESTRING,   _T("java") },
      { SCE_HJ_DOUBLESTRING,   _T("java") },
